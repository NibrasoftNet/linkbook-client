...
import { useGetMyCommunitiesFeedsRelatedMe } from '@/tanstack/community-feed.query';
import type { CommunityFeedValueType } from '@/types/community-feed.type';
import type { PaginationProps } from '@/types/types';

const CommunitiesFeedRelatedMe = ({
  searchParams,
}: {
  searchParams: PaginationProps;
}) => {
  const { data, isPlaceholderData } = useGetMyCommunitiesFeedsRelatedMe({
...
export default CommunitiesFeedRelatedMe;
