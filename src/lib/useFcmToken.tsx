...
const useFcmToken = () => {
  ...
  const { token, setToken } = useNotificationTokenStore(); // State to store the FCM token.
  ...
  return { token, setToken, notificationPermissionStatus, loadToken }; // Return the token and permission status.
};
